...
public abstract class MarketingContractTestBase {
    ...
    private static final BigDecimal UNIT_PRICE = BigDecimal.valueOf(40.0);

    private static final int SPECIAL_UNIT_COUNT = 5;
    private static final String SPECIAL_ID = "abc";
    private static final BigDecimal SPECIAL_TOTAL_PRICE = BigDecimal.valueOf(150.0);

    private static final int REGULAR_UNIT_COUNT = 2;
    private static final BigDecimal REGULAR_TOTAL_PRICE = BigDecimal.valueOf(80.0);
    ...
    private SpecialController prepareSpecialController() {
        ...
        doReturn(specialPrice())
                .when(specials).calculateFor(ITEM_ID, UNIT_PRICE, SPECIAL_UNIT_COUNT);
        doReturn(regularPrice())
                .when(specials).calculateFor(ITEM_ID, UNIT_PRICE, REGULAR_UNIT_COUNT);
